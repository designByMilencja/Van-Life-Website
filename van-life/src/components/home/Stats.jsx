...
const Stats = () => (
    <section className={`${styles.flexCenter} flex-row flex-wrap mb-[20px] mt-[50px] ss:mt-[150px] sm:mt-[150px]`}>
        {stats.map((stat) => (<div key={stat.id} className={`flex-1 flex justify-center items-center flex-row m-3`}>
                <h2 className="font-poppins font-semibold xs:text-[40px] text-[30px] xs:leading-[53px] leading-[43px] text-white">{stat.value}</h2>
